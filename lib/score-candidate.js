...
## CANDIDATE TYPE
Write a two-part label that tells a hiring manager exactly what kind of person this candidate is, based only on what they actually demonstrated in their responses. Do not use generic, flattering, or vague labels.

Format exactly as one line:
CANDIDATE_TYPE: [How they work] with [Their standout trait or risk]

Rules:
- Both parts must be specific to this candidate's actual observed behaviour. A hiring manager who interviewed this person should read it and think "yes, that is exactly them."
- The first part describes their primary working style as shown across the scenarios. Be precise: not "Good Communicator" but "Clear and Direct Communicator Under Pressure" or "Structured Process Follower" or "Confident Self-Starter."
- The second part names their most important trait or risk. Be honest: not "Some Development Areas" but "Weak Follow-Through on Detail" or "Strong Escalation Instincts" or "Low Adaptability When Plans Change."
- Do not use any of these banned vague phrases: Good Worker, Strong Performer, Solid Candidate, Consistent Delivery, Some Issues, Development Areas, Mixed Results.
- The complete label must be 6-10 words total. No full stops.
