...
Write the narrative now. Return prose only.`
  ...
  console.log('[score] Result assembled. Score:', result.overall_score, '| Risk:', result.risk_level, '| PassProb:', result.pass_probability, '| Trajectory:', result.trajectory, '| RedFlags:', result.red_flags.length, '| ConfGap:', result.confidence_competence_gap)
  ...
  if (insertError) {
    ...
    if (/dimension_evidence|scoring_confidence|confidence_competence_gap/i.test(insertError.message || '')) {
