...
Write the narrative now. Return prose only.`
  ...
  if (insertError) {
    ...
    if (/dimension_evidence|scoring_confidence|confidence_competence_gap|failure_patterns_detected|consistency_summary|consistency_flag|percentile_basis/i.test(insertError.message || '')) {
