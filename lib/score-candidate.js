...
These observations must anchor every strength and watch-out you write. Do not write a strength that cannot be traced to a specific observation. Do not write a watch-out that is not supported by specific evidence from the responses.
