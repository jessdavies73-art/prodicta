...
Write in plain UK English. No jargon. No bullet points. No bold text.`
  ...
  // Expectation alignment (from 2a)
  const expectationRaw = getSection(text2a, 'EXPECTATION ALIGNMENT')
  ...
  // Leave analysis (from 2a)
  const leaveRaw = getSection(text2a, 'LEAVE ANALYSIS')
  ...
  // Simple view (from 2a)
  const simpleRaw = getSection(text2a, 'SIMPLE VIEW')
  let simpleView = null
  if (simpleRaw) {
