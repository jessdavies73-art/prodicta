...
CRITICAL FORMATTING RULE: Do not use any markdown formatting whatsoever. No **bold**, no *italic*, no ### headers, no bullet symbols, no backticks. Plain prose only. The system renders formatting — markdown appears as raw characters to the reader.
...
## ONBOARDING PLAN
Write exactly 6 entries — Week 1 through Week 6 ONLY. Stop at Week 6. Do not write Week 7 or beyond. Each week on its own line starting with "Week N:". Each entry must be specific to this candidate's identified gaps — not generic onboarding. Reference UK employment practices where relevant (CIPD probation guidance, ERA 2025 day-one rights). Minimum 2 sentences per week.

## INTERVIEW QUESTIONS
Write exactly 4 behavioural questions targeting the specific gaps this assessment revealed. Each question must be tied to something this candidate's responses showed. Format:
[number]. [Full question — STAR or situation-based format]
(Follow-up probe: [specific follow-up that tests whether their answer is genuine and not rehearsed])

## PRESSURE FIT NARRATIVES
One entry per dimension. Each must be a full paragraph of at least 60 words, quoting specific phrases and explaining what those phrases reveal about how this person behaves under pressure. Format:
...
Two sentences. First: describe the quality pattern across scenarios. Second: what this suggests about the candidate under varying conditions or sustained effort.`
  ...
  // Onboarding plan — exactly Week 1–6
