...
// Phase 2 Education shell. v0.5: 5 of 9 blocks are real interactive
// components (class-roster, lesson-plan, parent-communication,
// behaviour-incident, safeguarding-referral). The remaining 4
// (head-teacher-message, cohort-coordination, conversation-simulation,
// crisis-simulation) still share the office BlockPlaceholder until
// the next prompt. Bumps to v1.0 once all 9 blocks are real and
// per-block scorers are in place.
export const PD_EDUCATION_BLOCK_LIBRARY_VERSION = 'education-block-library-v0.5';
