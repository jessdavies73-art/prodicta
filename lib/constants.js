...
// Phase 2 Healthcare shell. Bumps to v1.0 once all 10 healthcare blocks
// are real (currently stubs that share the office BlockPlaceholder).
export const PD_HEALTHCARE_BLOCK_LIBRARY_VERSION = 'healthcare-block-library-v0.1-stub';
