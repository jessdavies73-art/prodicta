...
// Phase 2 Education shell. v1.0: all 9 blocks are real interactive
// components (class-roster, lesson-plan, parent-communication,
// behaviour-incident, safeguarding-referral, head-teacher-message,
// cohort-coordination, conversation-simulation, crisis-simulation).
// Per-block scorers (analogous to the office shell's
// lib/workspace-blocks/office/scoring/* fan-out) land in Phase 2.6;
// the rubric version tracks scoring changes independently of the
// block library version below.
export const PD_EDUCATION_BLOCK_LIBRARY_VERSION = 'education-block-library-v1.0';
