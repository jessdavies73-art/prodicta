...
// for an assessment whose shell may be 'office' (Phase 1, live) or
// 'healthcare' (Phase 2, gated by healthcare_workspace_enabled). The
// caller decides which shell to use based on assessment.shell_family;
...
// './office/catalogue' or './healthcare/catalogue' to keep 'use client'
