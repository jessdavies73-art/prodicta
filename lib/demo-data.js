...
Strong hire. Sophie is likely to exceed expectations within the first six months and is a credible candidate for Head of Marketing progression within 18 to 24 months. The evidence across all four scenarios consistently points to a candidate who combines commercial acuity with the interpersonal intelligence to deliver in complex, cross-functional environments.`,
    ...
    interview_questions: [
      'In your assessment, you described wanting two full weeks of data review before touching anything. Now imagine it\'s day three in this role: the CEO pulls you into a budget meeting and asks you to reforecast the Q2 marketing spend because Sales has missed pipeline targets and the board wants cuts. You haven\'t finished your audit yet. How do you approach that reforecast — and what do you tell the CEO about how reliable the numbers you\'re giving them actually are? (Follow-up probe: Where do you cut first when the marketing budget gets compressed mid-quarter, and how do you defend that call to a CEO who doesn\'t see marketing as a revenue function?)',
      'Your Scenario 4 response included a very specific measurement framework — MQL-to-SQL conversion targets, weekly reporting, adjusting lead qualification criteria at week six. In practice, you\'ll be presenting marketing performance to a CFO or CEO who wants to know if the spend is working, not what the MQL trend looks like. What does your monthly marketing performance report actually contain, and how do you translate campaign metrics into language that a finance-first exec finds credible? (Follow-up probe: How do you handle the conversation where your metrics look good but Sales is flat and the CFO is pointing at your budget?)',
      'Your assessment showed clear strength in the stakeholder management scenario — you proposed a shared KPI framework and identified the competing priorities before anyone named them. In a Marketing Manager role, Sales will always want more leads and Product will always want brand spend redirected to launches. Tell me about a specific quarter where you had to hold a marketing budget position against pressure from both sides simultaneously. What was the decision, how did you make the case, and what happened to the relationship afterward? (Follow-up probe: How do you maintain credibility with Sales when a campaign you championed doesn\'t deliver the pipeline they were expecting?)',
      'You wrote in your assessment that you\'d build a full project plan before touching anything. In this role, campaigns are already live on day one — agency relationships, spend commitments, creative in production. There\'s no clean-slate planning phase. Walk me through specifically how you\'d make your first budget decision: which live campaigns would you pause, which would you protect, and how would you make that call without yet knowing the full performance picture? (Follow-up probe: What\'s the fastest you\'ve had to make a significant channel budget reallocation decision, and how did you do it without adequate data?)',
    ],
  },
...
Hire with structured onboarding. Marcus has the interpersonal skills, execution instinct, and campaign experience to succeed in this role. The analytical gap is real but addressable with the right support in the first 60 days. Pair with a data-oriented analyst from day one and set explicit measurement KPIs in the 30-day review to build this capability early.`,
    ...
    interview_questions: [
      'In your assessment\'s data scenario you described managing channel performance by looking at "what\'s driving the most engagement and doubling down on that." In this role you\'ll be presenting channel ROI to the CFO quarterly and making the case for budget allocation across paid, owned, and earned. Walk me through exactly how you\'d build the business case for increasing the paid social budget from £80k to £130k — what data would you use, how would you model the projected return, and how would you respond if the CFO says "last quarter you told me paid social was working and pipeline contribution was flat"? (Follow-up probe: Which attribution model do you use for multi-touch campaigns, and how do you explain it to a finance team that has never heard of last-click versus data-driven?)',
      'Your assessment showed solid stakeholder instinct — you correctly read a sales-marketing tension as a communication gap, not a strategic one. But your response to that scenario was notably brief compared to your others, and the follow-through was light. In practice, how do you get two teams to align on a shared definition of a marketing-qualified lead when Sales thinks marketing\'s leads are low quality and marketing thinks Sales aren\'t working them? Walk me through a specific situation where you had to broker that conversation. (Follow-up probe: How do you hold Sales accountable for lead follow-up without damaging the relationship you need to do your job?)',
      'You wrote in your assessment: "I\'d rather launch a good campaign that we can iterate on than spend six weeks perfecting something that might miss the window entirely." Tell me about a specific campaign you launched before the measurement framework was fully set up — before you had clean attribution, proper UTMs, or agreed success metrics. What happened when you tried to report on performance to your leadership team, and what would you do differently? (Follow-up probe: How do you get sign-off on a campaign budget when you can\'t fully model the expected ROI in advance?)',
      'Your assessment flagged a moment where a campaign outcome was attributed partly to "unclear briefs from the client." In an in-house marketing role, the client is your internal stakeholders — Sales, Product, the CEO. Walk me through a specific campaign where the brief changed after you\'d already committed resources. What was the brief, what changed, what did it cost in time or budget, and — specifically — what was your role in not catching the misalignment earlier? (Follow-up probe: What process do you now have in place to lock the brief before any spend is committed?)',
    ],
  },
...
Proceed with caution — specific risks identified. Priya has the raw material to become a strong Sales Executive, but hiring her for a role that requires significant new business acquisition, competitive deal-making, or high-volume closing will require an explicit, structured development programme from day one. If the role is more account management and relationship-led, the risk profile is considerably lower.`,
    ...
    interview_questions: [
      'In your assessment\'s pricing objection scenario, a prospect challenged your value and your response was: "The price point is based on everything that\'s included — the integrations, the support, the onboarding. When you look at what you\'re getting, it\'s actually very competitive." A sophisticated B2B buyer will have already seen your competitor\'s pricing sheet before your call. They\'re not asking what\'s in the package — they\'re telling you the ROI doesn\'t justify the premium. Walk me through what you say next, word for word, when they come back with: "I hear you, but Competitor X covers 80% of what we need at 25% less." (Follow-up probe: That answer doesn\'t land. They say "we need to bring this back to the CFO and the number is still the problem." At what point do you flag the deal for commercial review, what information do you bring to that conversation with your manager, and what\'s your policy on discounting without sign-off?)',
      'Your assessment showed hesitancy at the close — you wrote "I\'d probably leave the ball in their court at that stage — let them come to me when they\'re ready." In a quota-bearing role, end-of-quarter pipeline is real. You have a deal you\'ve been working for six weeks sitting in legal review, your quarter closes in nine days, and your attainment depends on it signing this month, not next. What specifically do you do — not in principle, but in practice — to advance that deal without burning the relationship? (Follow-up probe: Have you ever missed quota because a deal you expected slipped a quarter? What actually happened, and what would you do differently at the pipeline management stage?)',
      'In your assessment\'s pipeline scenario, you described your process as "keeping a mental list of where each deal is and how it\'s feeling." In this role you\'ll carry 15 to 25 active accounts and present a pipeline forecast to your manager every week. Walk me through how you\'d set up your CRM for a fresh pipeline from day one: which stages would you use, what is the specific criterion for moving a deal from Stage 2 to Stage 3, and how do you distinguish a deal that\'s progressing from one that\'s just friendly? (Follow-up probe: Your manager asks which deals are closing this quarter. How do you answer that in a way that\'s defensible when one of them slips?)',
      'Your strongest assessment response was in discovery — you wrote: "I wouldn\'t go into that call with a prepared pitch. I\'d spend the first fifteen minutes asking about what\'s changed in their business and what they\'re trying to solve right now." That instinct is genuinely valuable and not common. Tell me about a discovery call where your questions uncovered something that made you completely restructure your pitch on the fly. What question was it, what did it surface, and how did you change your approach in the moment? (Follow-up probe: What do you do when a thorough discovery call reveals the prospect is not actually a good fit for your product — and your pipeline is already thin that month?)',
    ],
  },
...
Not recommended at this stage. The evidence across all four scenarios consistently indicates a candidate who is either not ready for this role level or whose responses do not accurately represent their capabilities. If the panel wishes to proceed, the interview questions below are designed specifically to probe whether genuine sales experience exists beneath the surface-level responses observed here. A structured work trial or sales simulation prior to offer would be strongly recommended.`,
    ...
    interview_questions: [
      'Two of your assessment scenarios were completed in under 90 seconds — Scenario 1 in around a minute, Scenario 3 in under 90 seconds. For context, those scenarios typically take three to five minutes of genuine deliberation. Before we go any further, I want to ask you directly: walk me through the last deal you personally closed — the name of the company, the title of the decision-maker who signed, the contract value, how long the deal took from first call to signature, and the specific objections you had to overcome to get it over the line. (Follow-up probe: What was the hardest conversation in that deal cycle — the moment it could have gone either way — and exactly what did you say?)',
      'In your assessment\'s negotiation scenario, your first response to a pricing objection was: "I\'d probably look at what we could do on the price to make it work for them — there\'s usually some flexibility if the deal is important enough." In a role with margin targets and commercial accountability, reaching for a discount as the opening move compresses deal value on every negotiation. Walk me through your actual process: what do you need to understand about the prospect\'s budget, their internal approval process, and the competitive landscape before you\'re willing to have a pricing conversation at all? (Follow-up probe: A prospect opens the call with "your price is too high." Exactly what do you say — word for word?)',
      'Your assessment showed a consistent pattern of deferring rather than engaging with challenges directly — in the conflict scenario you wrote: "I\'d probably take some time to reflect on the feedback and come back with a revised proposal — I don\'t want to push back in the moment." In sales, live objections happen on calls, in demos, in front of buying committees — there\'s no follow-up email option. Tell me about a specific time a prospect challenged you directly on a live call with no time to prepare. What was the objection, what did you say, and what happened? (Follow-up probe: What made it difficult to address in the moment, and what would you say differently if it happened today?)',
      'Your assessment responses used terms like "customer-centric approach" and "pipeline hygiene" without examples behind them. I want to test both of those now. First, pipeline: you have 20 active accounts in your CRM. Your manager asks in your weekly pipeline review which three deals are closing this quarter and why. Give me your answer — not the process, the actual answer, with the specific criteria that make those three deals "closing this quarter" and not "probably closing next quarter." (Follow-up probe: One of those three goes completely quiet the next day. How many days before you escalate to your manager, and what does that escalation conversation look like?)',
    ],
  },
...
Strong hire. Elena is likely to make a visible impact within the first 60 days and is a credible candidate for senior developer or tech lead progression within 12 to 18 months. The technical communication gap is minor and easily addressed with an explicit focus in the onboarding plan. Pair her with a product manager who will provide direct feedback on communication clarity from day one.`,
    ...
    interview_questions: [
      'In your assessment\'s technical blocker scenario, you explained a database constraint as: "The current architecture doesn\'t support the transaction isolation level we\'d need for this to be consistent — it\'s a fundamental distributed systems constraint." Your product manager is about to commit that feature to a customer demo in two weeks. They\'re not a distributed systems engineer — they need to understand what this means for the roadmap and the customer. How do you explain it in a way that lets them make an informed decision about the tradeoff rather than either dismissing the risk or escalating it unnecessarily? (Follow-up probe: Your explanation lands and the PM decides to proceed with the risk accepted. Two weeks later, the demo breaks in exactly the way you warned about. How do you handle that conversation?)',
      'Your assessment\'s incident response was one of the strongest we\'ve seen — scoping before acting, checking deployment history and the dependency graph before considering a rollback, proactively communicating to customer success before they asked. In a real incident there\'s a second layer: your engineering manager, the head of product, and a customer-facing team are all asking for status updates simultaneously while you\'re the person closest to the fix. Walk me through how you manage the communication side of an active incident without it becoming a second incident. (Follow-up probe: What\'s the communication you wish you\'d sent earlier in the last production incident you were personally involved in?)',
      'In Scenario 3 of your assessment, a product manager suggested a technically unsound approach and you responded: "There\'s a reliability risk I\'d want us to address first — can we spend twenty minutes walking through it together?" In sprint planning, that conversation rarely gets twenty minutes. The PM says the sprint is already behind, the feature is on the roadmap, and engineering is blocking delivery. Where exactly is your line between accepting the ticket as tech debt and refusing to ship? (Follow-up probe: Tell me about a specific piece of code you shipped that you weren\'t happy with under deadline pressure. What was the consequence, and how did you manage it afterward?)',
      'Your assessment showed strong delivery instinct — you explicitly chose the simpler, more reliable solution when presented with an over-engineered alternative, which is a sign of professional maturity. In practice, code review is where that instinct gets tested. Walk me through your personal non-negotiables in code review: what do you always flag regardless of sprint pressure, and where will you accept a pragmatic shortcut when the deadline is real? (Follow-up probe: Tell me about a PR you approved that you later regretted — what were you weighing up, what did you decide, and what would you do differently?)',
    ],
  },
}
