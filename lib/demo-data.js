...
export const DEMO_ASSESSMENTS = [
  { id: 'demo-assess-1', role_title: 'Office Manager', status: 'active', detected_role_type: 'operations', assessment_mode: 'standard', employment_type: 'permanent', candidate_count: 1, created_at: '2026-04-20T10:00:00Z' },
  { id: 'demo-assess-2', role_title: 'Receptionist', status: 'active', detected_role_type: 'admin', assessment_mode: 'standard', employment_type: 'permanent', candidate_count: 1, created_at: '2026-04-18T10:00:00Z' },
  { id: 'demo-assess-3', role_title: 'Finance Manager', status: 'active', detected_role_type: 'finance', assessment_mode: 'standard', employment_type: 'permanent', candidate_count: 0, created_at: '2026-04-15T10:00:00Z' },
  { id: 'demo-assess-4', role_title: 'Customer Service Advisor', status: 'active', detected_role_type: 'customer_service', assessment_mode: 'quick', employment_type: 'permanent', candidate_count: 0, created_at: '2026-04-12T10:00:00Z' },
  { id: 'demo-assess-5', role_title: 'Assistant Management Accountant', status: 'active', detected_role_type: 'finance', assessment_mode: 'standard', employment_type: 'permanent', candidate_count: 0, created_at: '2026-04-10T10:00:00Z' },
]
...
Strong hire. Sophie is likely to exceed expectations within the first six months and is a credible candidate for Head of Marketing progression within 18 to 24 months. The evidence across all four scenarios consistently points to a candidate who combines commercial acuity with the interpersonal intelligence to deliver in complex, cross-functional environments.`,
    ...
    predictions: { pass_probation: 92, top_performer: 76, churn_risk: 7, underperformance_risk: 5 },
...
Hire with structured onboarding. Marcus has the interpersonal skills, execution instinct, and campaign experience to succeed in this role. The analytical gap is real but addressable with the right support in the first 60 days. Pair with a data-oriented analyst from day one and set explicit measurement KPIs in the 30-day review to build this capability early.`,
    ...
    predictions: { pass_probation: 78, top_performer: 45, churn_risk: 16, underperformance_risk: 21 },
...
Proceed with caution , specific risks identified. Priya has the raw material to become a strong Sales Executive, but hiring her for a role that requires significant new business acquisition, competitive deal-making, or high-volume closing will require an explicit, structured development programme from day one. If the role is more account management and relationship-led, the risk profile is considerably lower.`,
    ...
    predictions: { pass_probation: 62, top_performer: 26, churn_risk: 34, underperformance_risk: 38 },
...
Not recommended at this stage. The evidence across all four scenarios consistently indicates a candidate who is either not ready for this role level or whose responses do not accurately represent their capabilities. If the panel wishes to proceed, the interview questions below are designed specifically to probe whether genuine sales experience exists beneath the surface-level responses observed here. A structured work trial or sales simulation prior to offer would be strongly recommended.`,
    ...
    predictions: { pass_probation: 27, top_performer: 6, churn_risk: 65, underperformance_risk: 74 },
...
Strong hire. Elena is likely to make a visible impact within the first 60 days and is a credible candidate for senior developer or tech lead progression within 12 to 18 months. The technical communication gap is minor and easily addressed with an explicit focus in the onboarding plan. Pair her with a product manager who will provide direct feedback on communication clarity from day one.`,
    ...
    predictions: { pass_probation: 87, top_performer: 63, churn_risk: 10, underperformance_risk: 12 },
...
Hire with a clear development plan. Pair Ryan with a senior team leader or operations manager for the first 60 days who can model and coach difficult feedback conversations. Set an explicit expectation in the 30-day review that Ryan will have held at least one structured performance conversation with a team member. The risk is real but manageable, and his customer-facing strengths more than compensate in a role where most of the day is spent supporting front-line agents and difficult calls.`,
    ...
    scores: {
      ...
      'Prioritisation':  74,
      'Leadership':      65,
      'Execution Reliability': 71,
    },
    score_narratives: {
      'Communication':   'Genuine strength. Ryan is a warm, clear communicator with strong instincts for tone and pacing on customer calls. His Scenario 1 de-escalation script was specific and humane. The development edge is in using the same communication skills for difficult internal conversations, where he currently softens too much.',
      'Problem Solving': 'Solid on familiar customer problems where the shape of the answer is known. Less confident with people problems or any situation that does not have a clear customer-service playbook. Tends to defer rather than reason through unfamiliar situations.',
      'Prioritisation':  'Manages volume and queue well. Sequencing is driven by who is most visible rather than by impact. Will benefit from explicit triage criteria in the first 30 days.',
      'Leadership':      'The development area. Ryan is well-liked and will build strong relationships with his team quickly, but he avoids the harder side of leadership , direct feedback, performance conversations, and naming underperformance. This needs structured coaching from day one.',
    },
    strengths: [
      {
    ...
    predictions: { pass_probation: 75, top_performer: 32, churn_risk: 18, underperformance_risk: 22 },
  ...
  'demo-c11': {
    ...
    scores: { Communication: 72, Judgment: 70, Prioritisation: 74 },
    score_narratives: {
      Communication: 'Clear, direct response with no waffle. Appropriate for operational role.',
      Judgment: 'Made a sensible call on the scenario. Did not overthink.',
      Prioritisation: 'Correctly identified the urgent customer issue as top priority.',
    },
    strengths: [
    ...
    watchouts: [
      { watchout: 'Limited initiative shown', severity: 'Low', explanation: 'Response was correct but did not go beyond the minimum. May need prompting to take ownership.', evidence: 'Did not suggest follow-up actions or escalation steps.', action: 'Probe at interview for examples of proactive problem-solving.' },
    ],
    interview_questions: [
      'Tell me about a time you had to deal with an angry customer while managing other tasks. What did you do first and why?',
    ],
    onboarding_plan: [
    ...
    predictions: { pass_probation: 76, top_performer: 22, churn_risk: 15, underperformance_risk: 20 },
