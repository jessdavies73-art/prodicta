...
Strong hire. Sophie is likely to exceed expectations within the first six months and is a credible candidate for Head of Marketing progression within 18 to 24 months. The evidence across all four scenarios consistently points to a candidate who combines commercial acuity with the interpersonal intelligence to deliver in complex, cross-functional environments.`,
    ...
    interview_questions: [
      ...
      'How do you decide when to launch something imperfect versus wait until it\'s right? (Follow-up probe: Give me a specific example where you got that balance wrong.)',
    ],
  },
...
Hire with structured onboarding. Marcus has the interpersonal skills, execution instinct, and campaign experience to succeed in this role. The analytical gap is real but addressable with the right support in the first 60 days. Pair with a data-oriented analyst from day one and set explicit measurement KPIs in the 30-day review to build this capability early.`,
    ...
    interview_questions: [
      'Describe a marketing campaign you\'re most proud of. Walk me through your measurement approach. (Follow-up probe: How did you connect marketing activities to revenue outcomes — not just engagement metrics?)',
      'Tell me about a time you had to change direction mid-campaign. What triggered it, and how did you manage the change? (Follow-up probe: What data told you it wasn\'t working, and how quickly did you act?)',
      ...
      'Describe a difficult conversation with a senior stakeholder. What was your approach? (Follow-up probe: What would you do differently in that situation today?)',
    ],
  },
...
Proceed with caution — specific risks identified. Priya has the raw material to become a strong Sales Executive, but hiring her for a role that requires significant new business acquisition, competitive deal-making, or high-volume closing will require an explicit, structured development programme from day one. If the role is more account management and relationship-led, the risk profile is considerably lower.`,
    ...
    interview_questions: [
      'Tell me about a deal you lost that you thought you were going to win. What happened? (Follow-up probe: What could you have done differently at the objection stage specifically?)',
      ...
      'Describe your ideal pipeline review process. How do you know when a deal is truly moving? (Follow-up probe: What happens when a deal goes quiet for two weeks?)',
    ],
  },
...
Not recommended at this stage. The evidence across all four scenarios consistently indicates a candidate who is either not ready for this role level or whose responses do not accurately represent their capabilities. If the panel wishes to proceed, the interview questions below are designed specifically to probe whether genuine sales experience exists beneath the surface-level responses observed here. A structured work trial or sales simulation prior to offer would be strongly recommended.`,
    ...
    interview_questions: [
      'Tell me about the last deal you closed — walk me through every stage from first contact to signature, including the names of the stakeholders involved. (Follow-up probe: What was the hardest objection you faced and exactly how did you handle it?)',
      'What was the last deal you lost that you shouldn\'t have? What specifically did you do wrong? (Follow-up probe: What would you do differently at the objection stage if you could replay that conversation?)',
      ...
      'Tell me about a time you had a difficult conversation with a client or prospect that you had been avoiding. How did you approach it? (Follow-up probe: What made it hard to address sooner?)',
    ],
  },
...
Strong hire. Elena is likely to make a visible impact within the first 60 days and is a credible candidate for senior developer or tech lead progression within 12 to 18 months. The technical communication gap is minor and easily addressed with an explicit focus in the onboarding plan. Pair her with a product manager who will provide direct feedback on communication clarity from day one.`,
    ...
    interview_questions: [
      'Tell me about a production incident you were involved in. Walk me through what happened, your role, and what you changed afterward. (Follow-up probe: How did you communicate with non-technical stakeholders during the incident, and what would you do differently?)',
      'Describe a situation where you disagreed with a technical decision that had already been made. How did you handle it? (Follow-up probe: What would you have done differently if you had been more junior at the time?)',
      'How do you decide how much test coverage is enough for a given feature? (Follow-up probe: Can you give a specific example where you traded test coverage for speed of delivery — and was it the right call?)',
      'Tell me about a time you had to explain a technical problem to someone non-technical. How did you approach it, and how did you know they understood? (Follow-up probe: What would you do differently based on how it landed?)',
    ],
  },
}
