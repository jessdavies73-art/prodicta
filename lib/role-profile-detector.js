...
const OFFICE_FUNCTIONS = [
  ...
  'software_dev', 'customer_service', 'operations', 'project_management',
  'procurement', 'admin_pa', 'public_sector', 'senior_leadership',
  'aerospace', 'multilingual', 'fmcg_wholesale',
]
...
- For sector_context: state the actual industry plainly (e.g. "B2B SaaS scaleup", "NHS trust", "high street retail group", "London law firm", "manufacturing"). Do not just echo the function.`
