...
const PUBLIC_PATHS = ['/', '/login', '/forgot-password', '/reset-password', '/how-it-works', '/pricing', '/terms', '/privacy', '/accessibility', '/assess', '/api/assess', '/sample-report', '/api/cron', '/demo', '/api/billing/', '/auth/', '/roadmap', '/placement', '/api/placement', '/api/engagement']
