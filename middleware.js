...
const PUBLIC_PATHS = ['/', '/login', '/forgot-password', '/reset-password', '/how-it-works', '/pricing', '/terms', '/privacy', '/assess', '/api/assess', '/sample-report', '/api/cron', '/demo', '/api/billing/', '/auth/', '/roadmap', '/placement', '/api/placement']
