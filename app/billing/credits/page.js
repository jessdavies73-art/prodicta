...
const PAYG_TYPES = [
  { type: 'rapid-screen', label: 'Rapid Screen', unit: 6,  note: '5-8 minute assessment per candidate' },
  { type: 'speed-fit',    label: 'Speed-Fit',    unit: 18, note: '15 minute assessment per candidate' },
  { type: 'depth-fit',    label: 'Depth-Fit',    unit: 35, note: '25 minute assessment per candidate' },
  { type: 'strategy-fit', label: 'Strategy-Fit', unit: 65, note: '45 minute leadership assessment' },
]
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          {loading ? null : isPaygUser ? (
            <div style={{ ...cs }}>
              ...
              {paygTab === 'credits' && (
                <div>
                  <h3 style={{ margin: '0 0 10px', fontSize: 15, fontWeight: 700, color: TX, fontFamily: F }}>Buy more credits</h3>
                      ...
                      return (
                        <div key={t.type} style={{
                          ...
                          <div style={{ minWidth: 180 }}>
                            ...
                            <div style={{ fontFamily: F, fontSize: 12.5, color: TX3 }}>£{t.unit} per assessment · {t.note}</div>
                          </div>
