              ...
              <div style={{ background: '#0f2137', padding: '24px 32px 28px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 10, marginBottom: 28 }}>
                  {[
                    ...
                    { title: 'Tuesday Reality', desc: 'Plain English description of what managing this person actually looks like day-to-day. Not the interview version. The version you get when everything is happening at once.' },
                    { title: 'Watch-outs with What Gets Tolerated framing', desc: 'Every risk reframed as what will happen if you do not address it, with specific triggers, timelines, and actions.' },
