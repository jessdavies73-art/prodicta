...
function DemoValidationBlock({ title, body }) {
  return (
    <div style={{
...
function DemoValidationLayer({ isMobile, candidateId, scenarioCount, expanded, onToggle }) {
  const isSophie = candidateId === 'demo-c1'
  const confidence = isSophie ? 'high' : 'medium'
  const confBody = confidence === 'high'
    ...
    <div className="no-print" style={{ marginBottom: 20 }}>
      <button
        ...
        style={{
          ...
          background: '#0f2137', color: '#fff', border: 'none',
        ...
        <div style={{ padding: '20px 22px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, minmax(0, 1fr))', gap: 14, marginBottom: 16 }}>
            <DemoValidationBlock
              ...
              body={`This candidate completed ${scenarioCount} role-specific scenarios built from the job description. Scenarios reflect the actual situations this person would face in their first 90 days. Responses were not timed against a generic question bank.`}
            />
            <DemoValidationBlock
            ...
            <DemoValidationBlock
              ...
              body="All responses were analysed for AI assistance, copy-paste patterns, response timing anomalies, and consistency signals. Verified Human badge confirmed."
            />
            <DemoValidationBlock
      ...
      <main style={{ marginLeft: isMobile ? 0 : 220, marginTop: isMobile ? 96 : 46, padding: isMobile ? '16px 16px 32px' : '32px 40px', maxWidth: 1000, boxSizing: 'border-box' }}>
        ...
        {results && (candidate?.assessments?.assessment_mode === 'rapid' || layer2Open) && (
          <>
                      ...
                      return (
                        <div key={i} style={{ background: GRNBG, border: `1px solid ${GRNBD}`, borderLeft: `4px solid ${GRN}`, borderRadius: '0 10px 10px 0', padding: '16px 18px' }}>
                          ...
                          <div style={{ paddingLeft: 34, marginBottom: 8 }}>
                            <DemoEvidencePill level={params.candidateId === 'demo-c1' ? 'strong' : 'moderate'} />
                          </div>
            ...
            {/* ── VALIDATION LAYER (demo hardcoded) ── */}
            <DemoValidationLayer
              isMobile={isMobile}
