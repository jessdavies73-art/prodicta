            ...
            {[
              {
                ...
                points: [
                  'Placement Risk Score predicts whether the hire will stick',
                  'Client-ready reports you can send in one click',
                  'Accountability trail protects you if a placement fails',
                  'Bulk invite 30+ candidates and auto-shortlist the best',
                ],
                bg: NAVY,
                dark: true,
              },
              {
                ...
                points: [
                  'Know who will pass probation before you hire them',
                  'Track outcomes and see your own prediction accuracy over time',
                  'Custom skill weightings for different roles and departments',
                  'Personalised onboarding plans for every candidate you hire',
                ],
                bg: '#f0fdf8',
                dark: false,
              },
