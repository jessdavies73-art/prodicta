...
export const metadata = {
  ...
  description: 'PRODICTA predicts probation outcomes before you make the offer. AI-powered work simulations that show you how candidates actually perform under pressure. Built for ERA 2025. From £99/month, £49 for the first 30 days.',
...
const FAQ_ITEMS = [
  ...
  { q: 'How much does PRODICTA cost?', a: 'Starter is £99 per month (£49 for the first 30 days) for 10 assessments and up to 2 users. Professional is £299 per month (£149 for the first 30 days) for 30 assessments and up to 5 users. Business is £499 per month (£249 for the first 30 days) for 100 assessments and up to 15 users. Extra users are £35 per user per month on any plan. All plans include every feature. Transparent pricing. No hidden fees. No setup costs.' },
