...
//   rapid:    1 scenario      (quick signal only, no full narrative report)
// quick: 2 scenarios (Speed-Fit, full scored report)
// standard: 2 scenarios (Depth-Fit, narrative report + Monday Morning Reality)
// advanced: 2 scenarios (Strategy-Fit, plus workspace simulation generated by
//                              /api/assessment/[id]/workspace-content)
...
ASSESSMENT STYLE: Stakeholder Conflict Navigation. Present two conflicting but equally valid opinions from senior stakeholders. "The CFO wants to cut the marketing budget by 40%. The CMO says this will destroy the brand. You are the MD. What do you do?" Build scenarios involving strategy, trade-offs, political intelligence, and high-stakes decisions. Test strategic thinking, stakeholder management, decision-making under ambiguity, and ability to lead through conflicting priorities. Expect detailed 250-400 word responses with nuanced reasoning. Frame scenarios in a boardroom context with named stakeholders holding opposing positions. A finance director gets a board presentation with conflicting data. A senior developer gets an architecture decision with trade-offs. Do NOT reduce these scenarios to simple task execution.`,
    ...
    const standard3Prompt = `You are a specialist assessment designer for UK businesses. Your job is to create TWO work simulation scenarios for this role. These are for a 25-minute Depth-Fit Assessment, designed to give a deep narrative read on whether this hire will succeed.
...
SCENARIO 2 - "Will they last under pressure?" (Type: "Pressure Test", Time: 14 minutes)
...
FORMATTING RULE: Never use em dash (—) or en dash (–) characters anywhere in the output. Use commas, full stops, or rewrite the sentence instead.` : isStandard ? standard3Prompt : `You are a specialist assessment designer for UK businesses. Your job is to create two work simulation scenarios that test whether this specific leadership hire will succeed and last. The assessment also includes a separate Day 1 workspace simulation covering inbox, calendar and prioritisation. You do NOT need to produce that here.
...
STEP 2 - WRITE 2 SCENARIOS, EACH TESTING A DIFFERENT DIMENSION OF SUCCESS
