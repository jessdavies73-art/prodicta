...
export async function GET(request, { params }) {
  try {
    ...
    // Footer with the standard PRODICTA compliance disclaimer, adapted for
    // the candidate-facing development tone (no "hiring decision" reference).
    ...
    lastPage.drawText(safe(`Provided by ${companyName} in partnership with PRODICTA`), { x: 40, y: 7, size: 8, font: helv, color: rgb(0.85, 0.95, 0.95) })
